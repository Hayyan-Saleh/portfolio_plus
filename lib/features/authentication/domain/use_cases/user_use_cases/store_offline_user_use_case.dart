...
class StoreOfflineUserUseCase extends Equatable {
  final UserRepository userRepository;

  const StoreOfflineUserUseCase({required this.userRepository});

  Future<Either<AppFailure, UserModel>> call(UserModel user) async {
    return await userRepository.storeOfflineUser(user);
  }
